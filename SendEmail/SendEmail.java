...
{    
	 ...
	 {   
		   String[] recipients = {"shubhammuniyal@gmail.com"};	// enter valid emails only as it does not check if email exists of not
		   SendEmail.send("123tmails@gmail.com", "12345pass",	recipients,	"This is subject part", "text message");  // enter your details
		   SendEmail.sendWithAttachment("123tmails@gmail.com", "12345pass",	recipients,	"This is subject part", "text message","C:/Users/shubham/workspace1/final/scrappedInfo.csv");  // enter your details
	 ...
	 // Overloaded
	    ...
	    */
	    ...
	    {  
	    		...
	    		//SendEmail.send(from,password,recipient,sub,msg,);
	    }
}
