...
public class SendEmail{    
	 public static void main(String[] args) {   
		   ...
		   SendEmail.send("your email", "your password",	recipients,	"Not so urgent", "text message");  // enter your details
		   SendEmail.sendWithAttachment("your email", "your password",	recipients,	"This is subject part", "text message","E:\\interestingImages\\natureSea.jpeg");
	 }    
