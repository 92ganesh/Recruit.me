	...
	//**********************************************************************************
	    ...
	    */
		...
		public static String selectPassword(String tableName,String employerEmail){
		 ...
		 /**
		   *details:- checks whether is candidate selected for next round 
		   *@param tableName
		   *@param regNo
		   *returns String having registration number,name and invite for next round as 'YES' or 'NO' 
		   */
		...
		/**
		   *details:-updates a candidatesDetails table of invite_for_next_round from 'NO' to 'YES'
		   *@param tableName
		   *@param regNo
		   */
